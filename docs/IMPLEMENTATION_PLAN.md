...
| **Phase 4 — Main-process processors**                 | IN PROGRESS              | PRs #659–#662; `feat/sector-timing-processor` | Fuel was pulled forward into Phase 3. Lap times, car speeds, reference laps, and relative gaps are on `main`; sector timing is the active migration. Standings remains before the legacy telemetry stream can be removed or restricted to development.                                                                                                                    |
...
- [ ] SectorTimingProcessor — active on `feat/sector-timing-processor`
- [ ] StandingsProcessor
...
- **2026-08-08** — Relative Gaps PR #662 merged. Started the demand-driven Sector Timing migration with a typed snapshot, clean and incident-inclusive timing views, live/mock runtime wiring, renderer subscription adapter, and a seventh curated replay probe; Standings and legacy telemetry removal remain — `feat/sector-timing-processor` — implementation complete, review pending
