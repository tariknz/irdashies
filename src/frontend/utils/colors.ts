export const getTailwindStyle = (
  ...
  // Static map required so Tailwind's scanner picks up the class names
  const borderColorMap: Record<string, string> = {
    '#ffda59': 'border-yellow-500',
    '#eab308': 'border-yellow-500',
    '#f97316': 'border-orange-500',
    '#33ceff': 'border-blue-500',
    '#ff5888': 'border-pink-500',
    '#ae6bff': 'border-purple-500',
    ...
    '#d946ef': 'border-fuchsia-500',
    '#f43f5e': 'border-rose-500',
    '#71717a': 'border-zinc-500',
    '#78716c': 'border-stone-500',
    '#0ea5e9': 'border-sky-500',
  };
  ...
  > = {
    '#ffda59': {
      ...
      borderColor: borderColorMap['#ffda59'],
    },
    '#f97316': {
      ...
      borderColor: borderColorMap['#f97316'],
    },
    '#33ceff': {
      ...
      borderColor: borderColorMap['#33ceff'],
    },
    '#ff5888': {
      ...
      borderColor: borderColorMap['#ff5888'],
    },
    '#ae6bff': {
      ...
      borderColor: borderColorMap['#ae6bff'],
    },
    '#ef4444': {
      ...
      borderColor: borderColorMap['#ef4444'],
    },
    '#f59e0b': {
      ...
      borderColor: borderColorMap['#f59e0b'],
    },
    '#eab308': {
      driverIcon: 'bg-yellow-800 border-yellow-500',
      classHeader: 'bg-yellow-500 border-yellow-500',
      fill: 'fill-yellow-500',
      canvasFill: getColor('yellow'),
      borderColor: borderColorMap['#eab308'],
    },
    '#84cc16': {
      ...
      borderColor: borderColorMap['#84cc16'],
    },
    '#22c55e': {
      ...
      borderColor: borderColorMap['#22c55e'],
    },
    '#10b981': {
      ...
      borderColor: borderColorMap['#10b981'],
    },
    '#14b8a6': {
      ...
      borderColor: borderColorMap['#14b8a6'],
    },
    '#06b6d4': {
      ...
      borderColor: borderColorMap['#06b6d4'],
    },
    '#6366f1': {
      ...
      borderColor: borderColorMap['#6366f1'],
    },
    '#8b5cf6': {
      ...
      borderColor: borderColorMap['#8b5cf6'],
    },
    '#d946ef': {
      ...
      borderColor: borderColorMap['#d946ef'],
    },
    '#f43f5e': {
      ...
      borderColor: borderColorMap['#f43f5e'],
    },
    '#71717a': {
      ...
      borderColor: borderColorMap['#71717a'],
    },
    '#78716c': {
      ...
      borderColor: borderColorMap['#78716c'],
    },
    '#0ea5e9': {
      ...
      borderColor: borderColorMap['#0ea5e9'],
    },
  };

  const result = classColorMap[hex] ??
