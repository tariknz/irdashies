...
// Map CarID to car manufacturer
const getCarManufacturerFromCarID = (carId: number): string => {
  return CAR_ID_TO_CAR_MANUFACTURER[carId];
};

export const CarManufacturer: React.FC<CarManufacturerProps> = ({
                                                    carId,
                                                    className = '',
                                                    size = 'md',
                                                  }) => {
