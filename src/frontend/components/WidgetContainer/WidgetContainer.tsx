        ...
        {editMode && (
          <>
            ...
            >
              ...
              <svg
                aria-hidden="true"
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-full pointer-events-none"
                width="6"
                height="10"
                viewBox="0 0 6 10"
              >
              ...
              <svg
                aria-hidden="true"
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-full pointer-events-none"
                width="6"
                height="10"
                viewBox="0 0 6 10"
              >
