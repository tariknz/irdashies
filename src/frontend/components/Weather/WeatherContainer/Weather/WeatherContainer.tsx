...
export const WeatherContainer = () => {
   ...
   const WIND_COLOR = weather.windVelo?.value[0] * 3.6
   ...
   const METER_STYLE = `bg-blue-600 h-2.5 rounded-full w-[${weather.trackMoisture?.value}%]`;

   const TRACK_TEMP = useTrackTemperature();
   return (
      <div className="m-w-[500px] h-full inline-flex flex-row border-1 bg-slate-800 bg-opacity-25 rounded" ref={parent}>
