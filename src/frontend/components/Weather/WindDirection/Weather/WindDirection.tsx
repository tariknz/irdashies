...
export const WindDirection = () => {
  ...
  const WIND_DIRECTION_VALUE = weather.windDirection?.value[0] - weather.windYaw?.value[0];
  const WIND_DIRECTION = {
    rotate: `calc(${WIND_DIRECTION_VALUE} * 1rad + 0.5turn)`
  }

  return (
    <div id="wind" ref={parent} className="flex shrink h-full relative min-h-[200px] bg-slate-800">
