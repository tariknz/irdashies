  ...
  return (
    <div className="space-y-3 pl-4">
      {displayItems.map((item) => {
        ...
        const itemConfig = (settings.config[barType] as StandingsWidgetSettings['config']['headerBar'])?.[item.id as keyof StandingsWidgetSettings['config']['headerBar']] as { enabled: boolean } | undefined;
