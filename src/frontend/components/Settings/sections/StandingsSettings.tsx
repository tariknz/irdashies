...
const sortableSettings: SortableSetting[] = [
  ...
  { id: 'positionChange', label: 'Position Change', configKey: 'positionChange', canRotate: true },
  { id: 'delta', label: 'Delta', configKey: 'delta', canRotate: true },
  { id: 'gap', label: 'Gap', configKey: 'gap', hasSubSetting: true, canRotate: true },
  { id: 'interval', label: 'Interval', configKey: 'interval', hasSubSetting: true, canRotate: true },
  { id: 'fastestTime', label: 'Best Time', configKey: 'fastestTime', hasSubSetting: true, canRotate: true },
  { id: 'lastTime', label: 'Last Time', configKey: 'lastTime', hasSubSetting: true, canRotate: true },
  { id: 'lapTimeDeltas', label: 'Live Delta', configKey: 'lapTimeDeltas', hasSubSetting: true, canRotate: true },
          ...
          >
            ...
            {item.hasSubSetting &&
              ...
              (configValue as { enabled: boolean }).enabled && (
                <div className="flex items-center justify-between pl-3 mt-2">
                  ...
                  <select
                    value={(configValue as { decimalPlaces: number }).decimalPlaces}
                    onChange={(e) => {
                      handleConfigChange({
                        [item.configKey]: {
            ...
            {item.hasSubSetting &&
              ...
              settings.config.lapTimeDeltas.enabled && (
                <div className="flex items-center justify-between pl-3 mt-2">
                  <span className="text-sm text-slate-300">Number of Laps</span>
                  <select
                      ...
                      onClick={() => {
                        handleConfigChange({
                          badge: {
                            ...
                            badgeFormat: format as StandingsBadgeFormat,
                          },
                        });
                      }}
                    />
                ...
                <>
                  <SettingsSection title="Class Header">
                    <SettingToggleRow
                      ...
                      enabled={settings.config.classHeaderStyle?.className?.colorBackground ?? true}
                      onToggle={(newValue) =>
                        handleConfigChange({
                          classHeaderStyle: {
