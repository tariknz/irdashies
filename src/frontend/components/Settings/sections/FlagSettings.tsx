                ...
                <div className="pl-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Set how many seconds between on/off when animation is
                        enabled. Min 0.1s, Max 3s.
                      </p>
                    </div>
                    <input
                      type="number"
                      ...
                      onChange={(e) => {
                        ...
                        if (!Number.isNaN(v))
                          handleConfigChange({ blinkPeriod: v });
                      }}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Display &apos;no flag&apos; (grey leds) when no flags
                        are waved.
                      </p>
                    </div>
                    <ToggleSwitch
