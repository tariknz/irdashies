      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <span className="block text-xs text-slate-500">
            Enable a specific lap target for strategy
          </span>
        </div>
        <ToggleSwitch
        ...
        <div className="ml-1 pl-3 border-l-2 border-slate-700/50 space-y-3">
          <div className="flex items-center justify-between pr-2">
            <div>
              ...
              <span className="block text-xs text-slate-500">
                Scenarios will include this lap as a 4th row. Target message
                will show fuel required.
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ targetPitLap: parseInt(e.target.value) || 1 })
                }
          ...
          <div className="flex items-center justify-between pr-2">
            <div>
              ...
              <span className="block text-xs text-slate-500">
                Lap or laps to base the caluclation on.
              </span>
            </div>
            <select
              ...
              onChange={(e) =>
                onChange({
                  targetPitLapBasis: e.target
                    .value as FuelWidgetSettings['config']['targetPitLapBasis'],
                })
              }
              className="px-2 py-1 bg-slate-700 text-slate-200 rounded text-xs"
            >
              <option value="avg">
                Average ({settings.config.avgLapsCount})
              </option>
