...
export const findDirection = (trackId: number) => {
  ...
  const anticlockwiseTracks = [
    ...
    483, 498, 501, 502, 503, 504, 505, 508, 509, 510, 511, 512, 514, 515, 516,
    517, 518, 519, 520, 522, 526, 527, 528, 529, 530, 532, 536, 537, 540, 541,
    542, 543, 544, 545, 546, 550, 551, 552, 559, 561, 562, 563, 564, 565, 566,
    567, 569, 570, 571, 572, 573, 574, 575, 576, 578, 580, 583, 584, 585,
  ];
